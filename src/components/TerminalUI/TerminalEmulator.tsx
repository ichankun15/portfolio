...
//             if (project.github)
//               addLine("output", `   GitHub: ${project.github}`);
...
//       //     link.download = "Christian_Villafuerte_CV.pdf"; // new name for download
...
//       //     addLine(
//       //       "output",
//       //       "📄 Christian_Villafuerte_CV.pdf downloaded successfully!"
//       //     );
//       //     addLine(
//       //       "output",
//       //       "File saved to ~/Downloads/Christian_Villafuerte_CV.pdf"
//       //     );
//       //   }, 800);
//       //   break;
...
//           addLine(
//             "output",
//             "📄 Christian_Villafuerte_CV opened in a new tab!"
//           );
//         }, 800);
//         break;
...
const TerminalEmulator: React.FC<TerminalEmulatorProps> = ({ onModeSwitch }) => {
  ...
  return (
    <div className="terminal-container max-w-4xl mx-auto my-4 sm:my-8 px-2 sm:px-0">
      <TerminalHeader username={data.name} />
